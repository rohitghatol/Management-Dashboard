...
angular.module('organizations').controller('OrganizationsController', ['$scope', '$stateParams', '$location', 'Authentication', 'Organizations','Users',
	function($scope, $stateParams, $location, Authentication, Organizations,User) {
		...
		$scope.create = function() {
			...
			var organization = new Organizations ({
                ...
                billablePeople:this.billablePeople,
                benchPeople:this.benchPeople,
